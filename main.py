...
path = "replace this with the absolute path of your .txt file for storing the lowest price"

lowestPrice = open(path, "r")
currLowest = lowestPrice.read()
currLowestFloat = float(currLowest[1:6])
if float(price.text[1:6]) < currLowestFloat: #You only get emailed if the price is lower
